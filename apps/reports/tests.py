...
class ReportModelTest(TestCase):
    def setUp(self):
        ...
        self.category = Category.objects.create(name='Electroics', description='Electronics items')
...
class CreateReportAPIViewTest(APITestCase):
    def setUp(self):
        ...
        self.category = Category.objects.create(name='Books', description='Book category')
        self.product = Product.objects.create(
